...
public class AdapterSanPhamMoi extends RecyclerView.Adapter<AdapterSanPhamMoi.MyViewHolder> {
    Context context;
    List<SanPhamMoi> array;

    public AdapterSanPhamMoi(Context context, List<SanPhamMoi> array) {
