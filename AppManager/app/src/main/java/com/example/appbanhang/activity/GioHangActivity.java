...
import com.example.appbanhang.adapter.AdapterGioHang;
...
public class GioHangActivity extends AppCompatActivity {
    ...
    private void initControl() {
        ...
        if (Utils.manggiohang.size() == 0) {
            ...
            adapterGioHang = new AdapterGioHang(getApplicationContext(), Utils.manggiohang);
        ...
        btnmuahang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Utils.mangmuahang.size() == 0){
                    Toast.makeText(GioHangActivity.this, "Bạn chưa mua gì cả", Toast.LENGTH_SHORT).show();
                }else {
    ...
    private void initView() {
        giohangtrong = findViewById(R.id.giohang_txttrong);
        toolbar = findViewById(R.id.giohang_toolbar);
        recyclerView = findViewById(R.id.recycleviewgiohang);
        tongtien = findViewById(R.id.giohang_txttongtien);
